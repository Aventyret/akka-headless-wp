...
// NOTE: AKKA_CMS_MEDIA_BUCKET_BASE can be defined as AKKA_CMS_MEDIA_BUCKET_BASE or as a combo of AKKA_CMS_MEDIA_BUCKET_PROTOCOL, AKKA_CMS_MEDIA_BUCKET_HOSTNAME and AKKA_CMS_MEDIA_BUCKET_PORT
if (getenv('AKKA_CMS_MEDIA_BUCKET_BASE')) {
    define('AKKA_CMS_MEDIA_BUCKET_BASE', getenv('AKKA_CMS_MEDIA_BUCKET_BASE'));
} else if (getenv('AKKA_CMS_MEDIA_BUCKET_HOSTNAME')) {
    define('AKKA_CMS_MEDIA_BUCKET_BASE', getenv('AKKA_CMS_MEDIA_BUCKET_PROTOCOL') . '://' . getenv('AKKA_CMS_MEDIA_BUCKET_HOSTNAME') . getenv('AKKA_CMS_MEDIA_BUCKET_PORT'));
} else {
    define('AKKA_CMS_MEDIA_BUCKET_BASE', NULL);
}
