...
The plugin exposes an api to register custom taxonomies and to configure settings for these and ACF fields for their terms. This is done through the `Akka\Taxonomies` class.
